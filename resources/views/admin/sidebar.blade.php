<nav id="sidebar">
    ...
    <ul class="list-unstyled">
        <li class="active"><a href="{{ url('show_post') }}"> <i class="icon-home"></i>Home </a></li>
        ...
        <li><a href="{{ url('categories/create') }}"> <i class="icon-logout"></i>Add Category</a></li>
        <li><a href="{{ url('categories') }}"> <i class="icon-logout"></i>Show Category</a></li>
    </ul>
